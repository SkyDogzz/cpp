...
static bool isPseudoFloat(const std::string& s) { return (s == "nanf" || s == "+inff" || s == "-inff"); }

static bool isPseudoDouble(const std::string& s) { return (s == "nan" || s == "+inf" || s == "-inf"); }
...
static void printChar(double d, LiteralType type)
{
    ...
    if (d < 0.0 || d > 127.0 || d != d || d == std::numeric_limits<double>::infinity()
