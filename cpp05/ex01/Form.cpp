...
const char* Form::GradeTooHighException::what() const throw() { return "Form Grade Too High Excption"; }

const char* Form::GradeTooLowException::what() const throw() { return "Form Grade Too Low Excption"; }
...
std::ostream& operator<<(std::ostream& ostream, const Form& form) { return ostream << form.getName() << std::endl; }
