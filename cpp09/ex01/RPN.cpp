        ...
        if (isAnOperand(t)) {
            ...
            if (strcmp(t, "+") == 0)
                ...
                if (op1 == LONG_MIN && op2 == -1)
                    throw RPN::FloatingPointException();
                _operand.push_back(op1 / op2);
            }
        } else
...
const char* RPN::NorOperandOperatorException::what() const throw() { return "nor operand or operator"; }

const char* RPN::DivideByNothingException::what() const throw() { return "attempt to divide by 0"; }

const char* RPN::NoOperandToConsumeException::what() const throw() { return "expr need operand to consume"; }

const char* RPN::ContainsBadCharException::what() const throw() { return "contains bad characters"; }

const char* RPN::MultipleSpaceException::what() const throw() { return "multiple spaces"; }

const char* RPN::EvenNumberOfOpeException::what() const throw() { return "even numbers of ope"; }

const char* RPN::NotComsumedOperandException::what() const throw() { return "not all operands were comsumed"; }

const char* RPN::FloatingPointException::what() const throw() { return "floating point exception"; }
